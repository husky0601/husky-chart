...
var css = ".style-module_chart__2UWWs {\n    overflow: visible;\n}\n.style-module_chartElement__30REk{\n    pointer-events: none;\n}\n\n.style-module_gridLine__1LEoW{\n    stroke-width: 1px;\n    stroke: #e5e7ed\n}\n.style-module_gridLineContainer__23Oxi{\n    transition: transform 0.5s\n}\n.style-module_labelContainer__2acWa{\n    transition: transform 0.5s\n}\n.style-module_label__3_4lo{\n    font-size: 12px;\n    color: #525461;\n}\n.style-module_label-x__2IHEz{\n    text-anchor: middle;\n}\n.style-module_label-y__2Jfym{\n    text-anchor: inherit;\n    dominant-baseline: middle;\n}";
var styles = {"chart":"style-module_chart__2UWWs","chartElement":"style-module_chartElement__30REk","gridLine":"style-module_gridLine__1LEoW","gridLineContainer":"style-module_gridLineContainer__23Oxi","labelContainer":"style-module_labelContainer__2acWa","label":"style-module_label__3_4lo","label-x":"style-module_label-x__2IHEz","label-y":"style-module_label-y__2Jfym"};
styleInject(css);

/*eslint-disable no-unused-vars*/
const SPACER_ITEM = { label: 'ghost', value: 'spacer' };
function getCoordinate(value, axisItems, axisLength, offset, labelsBetween = false) {
    if (typeof value === 'string') {
...
function getSvgCoordinates(axisItems, axisLength, offset) {
    return axisItems.map((axisItem) => (Object.assign(Object.assign({}, axisItem), { svgCoordinate: getCoordinate(axisItem.value, axisItems, axisLength, offset, false) })));
}
function getValue$1(coordinates, axisItems, axisLength, offset, labelsBetween) {
    const start = axisItems[0].value;
    const end = axisItems[axisItems.length - 1].value;
    ...
    constructor(props) {
        ...
        this.setProperties = () => {
            ...
            this.getValues = (xCoordinate, yCoordinate) => {
                const x = getValue$1(xCoordinate, xAxisItems, xAxisItemLen, this.leftMargin, xLabelsBetween);
                const y = getValue$1(yCoordinate, yAxisItems, yAxisItemLen, this.topMargin, yLabelsBetween);
                return {
                    x: x && y ? x : null,
                    y: x && y ? y : null
                };
        ...
        this.throttledMouseUpdate = throttle((clientX, clientY) => {
